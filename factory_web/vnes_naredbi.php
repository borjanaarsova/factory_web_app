...
echo "<hr>";
if($_POST['masina']!="" && $_POST['proizvod']!="" && $_POST['kolicina']!="")
{
	$m=$_POST['masina'];
	$p=$_POST['proizvod'];
	$k=$_POST['kolicina'];
	$query="INSERT INTO `naredbi`(`ID_masina`, `ID_proizvod`, `ID_kolicina`) VALUES ('$m','$p','$k')";
...
echo "<center><h1>Успешно испратена наредба!<br><br><a href=".'./home_shefovi.php'.">Врати се назад</a></h1></center>";	
}
else
