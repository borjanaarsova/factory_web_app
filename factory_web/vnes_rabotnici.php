...
echo "<hr>";
if($_POST['ime']!="" && $_POST['prezime']!="" && $_POST['korisnicko_ime']!="" && $_POST['lozinka']!="" && $_POST['telefon']!="")
{
	$im=$_POST['ime'];
	$pr=$_POST['prezime'];
	...
	$lo=$_POST['lozinka'];
	$te=$_POST['telefon'];
	$query="INSERT INTO `vraboteni`(`Ime`, `Prezime`, `korisnicko_ime`, `lozinka`, `telefonski_broj`) VALUES ('$im','$pr','$ki','$lo','$te')";
...
echo "<center><h1>Успешен внес!<br><br><a href=".'./home_sopstvenici.php'.">Врати се назад</a></h1></center>";	
}
else
