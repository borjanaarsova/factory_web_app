...
{
	$d=$_POST['id'];
	$query="DELETE FROM `poraki` WHERE `ID`='$d'";
...
if($_SESSION['uloga']=="shef")
	echo "<center><h1>Успешно бришење!<br><br><a href=".'./home_shefovi.php'.">Врати се назад</a></h1></center>";
else
	echo "<center><h1>Успешно бришење!<br><br><a href=".'./home_sopstvenici.php'.">Врати се назад</a></h1></center>";	
}
else
{
	if ($_SESSION['uloga']=="shef")
